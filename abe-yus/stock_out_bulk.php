...
try {
    ...
    $sql = "INSERT INTO public.stock_out (
        month_date, month, year, day, code, name, description, category,
        unit_price, packet, unit, total_used_box
    ) VALUES (
        :month_date, :month, :year, :day, :code, :name, :description, :category,
        :unit_price, :packet, :unit, :total_used_box
    )
    ON CONFLICT (month_date, code) DO UPDATE SET
        ...
        unit = EXCLUDED.unit,
        total_used_box = EXCLUDED.total_used_box";
...
$params = [
    ...
    ':unit' => $item['unit'],
    ':total_used_box' => (int)$item['total_transaction_out']
];
