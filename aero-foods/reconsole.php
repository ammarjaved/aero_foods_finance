...
try {
    ...
    if (!isset($_GET['year']) || !isset($_GET['db'])) {
        echo json_encode([
            ...
            'usage' => [
                'For specific month' => 'reconsole.php?year=2024&month=1&db=aero_foods_finance&user=admin',
                'For entire year' => 'reconsole.php?year=2024&db=aero_foods_finance&user=admin'
            ]
        ]);
        exit;
    }
