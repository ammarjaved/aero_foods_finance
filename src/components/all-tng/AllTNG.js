                  ...
                  <div style={{ overflowX: "auto" }}>
                    <table className="table table-bordered table-hover table-sm mb-0 text-center">
                      <thead style={{ position: "sticky", top: 0, zIndex: 1 }}>
                        ...
                        {/* Row 2: Duit Now / TNG / Variance sub-headers */}
                      ...
                      <tbody>
                        {allDates.map((date) => {
                          ...
                          const cells = OUTLETS.map((o) => {
                            ...
                            const var1 = tngBank - duit;
                            if (rec) { rowTotalTng += tngBank; rowTotalVariance += var1; }
                            return { rec, duit, tngBank, var1 };
                          });
                          ...
                          return (
                            <tr key={date}>
                              ...
                              {cells.map(({ rec, duit, tngBank, var1 }, i) => (
                      ...
                      <tfoot style={{ backgroundColor: "#e9ecef", fontWeight: "bold" }}>
                        <tr>
                          ...
                          {OUTLETS.map((o) => {
                            ...
                            const var1Total = tngBankTotal - duitTotal;
                            return (
                              <React.Fragment key={o.label}>
                                <td
                                  className="text-end"
                          ...
                          <td
                            ...
                            style={{
                              ...
                              color: variance1Color(
                                OUTLETS.reduce((s, o) => s + outletSum(o.label, "tng") - outletSum(o.label, "duit_now"), 0)
                              ),
                            }}
                          >
                            {fmt(OUTLETS.reduce((s, o) => s + outletSum(o.label, "tng") - outletSum(o.label, "duit_now"), 0))}
                          </td>
                        </tr>
                      </tfoot>
                    </table>
