    ...
    items.map((item, index) => (
      <div
        ...
        style={{ 
          ...
          paddingLeft: "25px",
          fontSize: "14px",
          backgroundColor: isCurrentPage(item.href) ? "rgba(255,255,255,0.2)" : "transparent",
      ...
      >
        {isCurrentPage(item.href) && "► "}{item.label}
      </div>
    ))
  );
    ...
    return (
      <div key={sectionKey} className="mb-2">
        <button
          ...
          style={{
            width: "100%",
            backgroundColor: hasActivePage ? "rgba(255,255,255,0.15)" : "rgba(255,255,255,0.1)",
        ...
        >
          <span>{hasActivePage && "● "}{title}</span>
          <span 
            style={{ 
              transform: activeSection === sectionKey ? "rotate(90deg)" : "rotate(0deg)",
          ...
          {isAdmin && (
            <div
              ...
              style={{ 
                ...
                cursor: "pointer",
                backgroundColor: isCurrentPage("/summary") ? "rgba(255,255,255,0.2)" : "rgba(255,255,255,0.1)",
                borderRadius: "4px",
                margin: "2px 0",
