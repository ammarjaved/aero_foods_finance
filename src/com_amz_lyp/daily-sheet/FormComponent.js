...
function FormComponent() {
  ...
  const handleChange = async (e) => {
    ...
    if (type !== "file") {
      ...
      const response = await fetch(
        "http://121.121.232.54:88/amazon-cafe-lyp/mtd_ts.php?date=" +
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        "http://121.121.232.54:88/amazon-cafe-lyp/daily_sheet.php",
        {
          method: "POST",
  ...
  const deleteRecord = async () => {
    ...
    try {
      const response = await fetch(
        "http://121.121.232.54:88/amazon-cafe-lyp/del.php",
        {
          method: "DELETE",
          headers: {
