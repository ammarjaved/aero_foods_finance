...
import TimetableAmazon from "./timetableamazon";

function TimeFormComponentAmazon() {
  ...
  const deleteRecord = async () => {
    ...
    try {
      const response = await fetch(
        "http://121.121.232.54:88/amazon-cafe-lyp/del1.php",
        {
          method: "DELETE",
          headers: {
...
export default TimeFormComponentAmazon;
