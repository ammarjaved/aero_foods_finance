...
function FormComponent() {
  ...
  const handleChange = async (e) => {
    ...
    if (type !== "file") {
      ...
      const response = await fetch(
        "http://121.121.232.54:88/abe-yus/mtd_ts.php?date=" +
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        "http://121.121.232.54:88/abe-yus/daily_sheet.php",
        {
          method: "POST",
  ...
  const deleteRecord = async () => {
    ...
    try {
      const response = await fetch("http://121.121.232.54:88/abe-yus/del.php", {
        method: "DELETE",
        headers: {
