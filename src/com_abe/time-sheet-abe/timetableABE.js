...
function TimetableABE({ onRowClick, onFilter, sortFilter, isFetch }) {
  ...
  useEffect(() => {
    ...
    fetch("http://121.121.232.54:88/abe-yus/fetchNames.php")
  ...
  const fetchData = () => {
    setLoading(true);
    fetch("http://121.121.232.54:88/abe-yus/fetchtimesheet.php")
      .then((res) => res.json())
      .then((fetchedData) => {
        setData(fetchedData);
  ...
  const handleCreate = async () => {
    ...
    const response = await fetch(
      "http://121.121.232.54:88/abe-yus/log_sheet.php",
      {
        method: "POST",
  ...
  const handleSave = (id) => {
    ...
    fetch("http://121.121.232.54:88/abe-yus/log_sheet.php", {
      method: "POST",
  ...
  const handleDelete = (id) => {
    ...
    fetch("http://121.121.232.54:88/abe-yus/del1.php", {
      method: "DELETE",
                                    ...
                                    <img
                                      src={
                                        ...
                                        !editFormData[col.key].startsWith(
                                          ...
                                          ? `http://121.121.232.54:88/abe-yus/${
                                              editFormData[col.key]
                                            }`
                                          : typeof editFormData[col.key] ===
                                              "string" &&
