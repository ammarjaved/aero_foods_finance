    ...
    const [formData, setFormData] = useState({
      ...
      const handleSubmit = async (e) => {
        ...
        try {
          ...
          const response = await fetch('http://121.121.232.54:88/aero-foods/log_sheet.php', {
            method: 'POST',
     ...
     window.location.reload();
      ...
      const deleteRecord = async () => {
        ...
        try {
          const response = await fetch('http://121.121.232.54:88/aero-foods/del1.php', {
            method: 'DELETE',
            headers: {
        ...
        <div className="col-12">
          <div className="card">
            ...
            <div className="card-body">
              <TimeTable  onRowClick={handleRowClick} />
            </div>
