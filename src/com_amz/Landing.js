import React, { useState,useEffect } from 'react';
 ...
 function LandingAmz(){
      ...
      const fetchReportData = async () => {
        try {
          setIsLoading(true);
          const response = await fetch('http://121.121.232.54:88/amazon-cafe/target.php');
      ...
      const handleInputChange = (e) => {
        ...
        const parsed = name === 'month' || name === 'year' ? parseInt(value, 10) : parseFloat(value);
        setFormData({
          ...formData,
