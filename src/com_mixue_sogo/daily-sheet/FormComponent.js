...
function FormComponent() {
  ...
  const API_BASE_URL = "http://121.121.232.54:88/mixue-sogo";
  ...
  const handleChange = async (e) => {
    ...
    if (type !== "file") {
      ...
      const response = await fetch(
        "http://121.121.232.54:88/mixue-sogo/mtd_ts.php?date=" +
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        "http://121.121.232.54:88/mixue-sogo/daily_sheet.php",
        {
          method: "POST",
  ...
  const deleteRecord = async () => {
    ...
    try {
      const response = await fetch(
        "http://121.121.232.54:88/mixue-sogo/del.php",
        {
          method: "DELETE",
          headers: {
