...
function TimetableAmazon({ onRowClick, onFilter, sortFilter, isFetch }) {
  ...
  const fetchData = () => {
    setLoading(true);
    fetch("http://121.121.232.54:88/mixue-sogo/fetchtimesheet.php")
      .then((res) => res.json())
      .then((fetchedData) => {
        setData(fetchedData);
  ...
  const handleCreate = async () => {
    ...
    const response = await fetch(
      "http://121.121.232.54:88/mixue-sogo/log_sheet.php",
      {
        method: "POST",
  ...
  const handleSave = (id) => {
    ...
    fetch("http://121.121.232.54:88/mixue-sogo/log_sheet.php", {
      method: "POST",
  ...
  const handleDelete = (id) => {
    ...
    fetch("http://121.121.232.54:88/mixue-sogo/del1.php", {
      method: "DELETE",
                                    ...
                                    <img
                                      src={
                                        ...
                                        !editFormData[col.key].startsWith(
                                          ...
                                          ? `http://121.121.232.54:88/mixue-sogo/${
                                              editFormData[col.key]
                                            }`
                                          : typeof editFormData[col.key] ===
                                              "string" &&
